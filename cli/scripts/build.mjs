...
if (!existsSync(tsc)) {
  console.error(
    "Build failed: neither bun nor local TypeScript compiler is available.",
  );
  console.error(
    "Run `npm ci` first, or install Bun from https://bun.sh/docs/installation.",
  );
  process.exit(127);
}
